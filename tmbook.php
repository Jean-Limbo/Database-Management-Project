...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="tmbook.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/tm.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Magicians</div>
        <div class="author">Author: Lev Grossman</div>
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24844</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Magicians</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">61358304</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">October 8, 2009</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98456</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">6231171</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Lev Grossman</span>
        </div>
    </div>
</div>
