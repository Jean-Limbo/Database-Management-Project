...
<div class="cart-container">
    <div class="product-image">
        <img src="images/tinc.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Inheritance Cycle

        </div>
        <div class="author">Author: Christopher Paolini
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <<div class="detail">
            ...
            <span class="value">20877</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Inheritance Cycle</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">60580860</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">September 20, 2008</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98763</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">6171458</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Christopher Paolini</span>
        </div>
    </div>
</div>
