...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="hpbook.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/hp1.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        ...
        <div class="author">Author: J.K. Rowling</div>
...
<div class="bookitemsdetails">
    ...
    <div class="detail">
        ...
        <span class="value">24782</span>
    </div>
    <div class="detail">
        <span class="label">Title:</span>
        <span class="value">Harry Potter and the Philosopher's Stone</span>
    </div>
    <div class="detail">
        <span class="label">ISBN:</span>
        <span class="value">60566760</span>
    </div>
    <div class="detail">
    ...
    <div class="detail">
        ...
        <span class="value">June 26, 1997</span>
    </div>
    <div class="detail">
        <span class="label">Publisher ID:</span>
        <span class="value">98280</span>
    </div>
    <div class="detail">
        <span class="label">Author ID:</span>
        <span class="value">2792775</span>
    </div>
</div>
