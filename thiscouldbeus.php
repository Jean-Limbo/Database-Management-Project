...
<div class="cart-container">
    <div class="product-image">
        <img src="images/thcbu.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">This Could Be Us

        </div>
        <div class="author">Author: Kennedy Ryan
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">18554</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">This Could Be Us</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">62065351</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">March 5, 2024</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">90832</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">2267189</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Kennedy Ryan</span>
        </div>
    </div>
</div>
