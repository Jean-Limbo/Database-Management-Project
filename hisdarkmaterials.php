...
<div class="cart-container">
    <div class="product-image">
        <img src="images/hdm.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">His Dark Materials

        </div>
        <div class="author">Author: Philip Pullman
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24846</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">His Dark Materials</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">61429902</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">July 9, 1995</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Philip Pullman</span>
        </div>
    </div>
</div>
