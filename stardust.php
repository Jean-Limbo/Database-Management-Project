...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="stardust.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/stardust.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">Stardust</div>
        <div class="author">Author: Neil Gaiman
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">23328</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">Stardust</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">60914475</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">August 2, 1997</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">92346</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">2809203</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Neil Gaiman</span>
        </div>
    </div>
</div>
