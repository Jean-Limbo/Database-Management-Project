...
<div class="cart-container">
    <div class="product-image">
        <img src="images/ttv.jpg" height="500px" alt="Book Cover">
    </div>
   

    <div class="informationprod">
        <div class="product-title">Tipping the Velvet

        </div>
        <div class="author">Author: Sarah Waters
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        ...
        <span class="value">18263</span>
    </div>
    <div class="detail">
        <span class="label">Title:</span>
        <span class="value">Tipping the Velvet</span>
    </div>
    <div class="detail">
        <span class="label">ISBN:</span>
        <span class="value">006206262X</span>
    </div>
    <div class="detail">
    ...
    <div class="detail">
        ...
        <span class="value">October 4, 2018</span>
    </div>
    <div class="detail">
        <span class="label">Publisher ID:</span>
        <span class="value">98364</span>
    </div>
    <div class="detail">
        <span class="label">Author ID:</span>
        <span class="value">3203964</span>
    </div>
    <div class="detail">
    ...
    <div class="detail">
        ...
        <span class="value">Sarah Waters</span>
    </div>
    </div>
</div>
