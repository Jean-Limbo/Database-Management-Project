...
<div class="cart-container">
    <div class="product-image">
        <img src="images/spsonnet.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">Shakespeare's Sonnet
        </div>
        <div class="author">Author: William Shakespeare
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">28181</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">Shakespeare's Sonnets</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">61430838</span>
        </div>
        <div class="detail">
            <span class="label">Genre:</span>
            <span class="value">Poetry</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">February 17, 2014</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98465</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">3346751</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">William Shakespeare</span>
        </div>
    </div>
</div>
