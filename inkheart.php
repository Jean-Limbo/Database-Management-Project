...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="inkheart.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/inkheart.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">Inkheart</div>
        <div class="author">Author: Cornelia Funke        </div>
...
<div class="bookitemsdetails">
    ...
    <div class="detail">
        ...
        <span class="value">22241</span>
    </div>
    <div class="detail">
        <span class="label">Title:</span>
        <span class="value">Inkheart</span>
    </div>
    <div class="detail">
        <span class="label">ISBN:</span>
        <span class="value">60745924</span>
    </div>
    <div class="detail">
        <span class="label">Genre:</span>
        <span class="value">Mystery</span>
    </div>
    <div class="detail">
    ...
    <div class="detail">
        ...
        <span class="value">September 23, 2003</span>
    </div>
    <div class="detail">
        <span class="label">Publisher ID:</span>
        <span class="value">98312</span>
    </div>
    <div class="detail">
        <span class="label">Author ID:</span>
        <span class="value">2402163</span>
    </div>
    <div class="detail">
    ...
    <div class="detail">
        ...
        <span class="value">Cornelia Funke</span>
    </div>
