...
<div class="cart-container">
    <div class="product-image">
        <img src="images/thobt.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Hobbit

        </div>
        <div class="author">Author: J.R.R. Tolkien
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">21866</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Hobbit</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">64432092</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">September 21, 1937</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98300</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">13155899</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">J.R.R. Tolkien</span>
        </div>
    </div>
</div>
