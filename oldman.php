...
<div class="cart-container">
    <div class="product-image">
        <img src="images/oldman.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Old Man and The Sea


        </div>
        <div class="author">Author: Ernest Hemingway
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24848</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Old Man and The Sea
            </span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">61430013</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">September 27, 2014</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98276</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">41335427</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Ernest Hemingway</span>
        </div>
    </div>
</div>
