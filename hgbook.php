...
<div class="cart-container">
    <div class="product-image">
        <img src="images/hg1.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Hunger Games: The Ballad of Songbirds and Snakes

        </div>
        <div class="author">Author: Suzanne Collins
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24564</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Hunger Games</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">60557818</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">September 14, 2008</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98292</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">3212258</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Suzanne Collins</span>
        </div>
    </div>
</div>
