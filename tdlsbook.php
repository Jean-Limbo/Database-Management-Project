...
<div class="cart-container">
    <div class="product-image">
        <img src="images/tdlsogudj.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Dirty Little Secrets of Getting Your Dream Job

        </div>
        <div class="author">Author: Don Raskin
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24845</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Dirty Little Secrets of Getting Your Dream Job</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">61430455</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">January 8, 2015</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98265</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">4790821</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Don Raskin</span>
        </div>
    </div>
</div>
