...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="pjo.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/pj1.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">Percy Jackson and the Olympians
        </div>
        <div class="author">Author: Rick Riordan
        </div>
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24563</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">Percy Jackson and the Olympians</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">60557737</span>
        </div>
        <div class="detail">
            <span class="label">Genre:</span>
            <span class="value">Fantasy</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">June 28, 2005</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98282</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">4640799</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Rick Riordan</span>
        </div>
</div>
</div>
