...
<div class="cart-container">
    <div class="product-image">
        <img src="images/bcd.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">Behind Closed Doors

        </div>
        <div class="author">Author: B.A. Paris
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        ...
        <span class="value">24847</span>
    </div>
    <div class="detail">
        <span class="label">Title:</span>
        <span class="value">Behind Closed Doors</span>
    </div>
    <div class="detail">
        <span class="label">ISBN:</span>
        <span class="value">61429929</span>
    </div>
    <div class="detail">
        <span class="label">Genre:</span>
        <span class="value">Thriller</span>
    </div>
    <div class="detail">
    ...
    <div class="detail">
        ...
        <span class="value">B.A. Paris</span>
    </div>
    </div>
</div>
