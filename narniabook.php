...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="narniabook.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/tcn1.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Chronicles of Narnia
        </div>
        <div class="author">Author: C. S. Lewis
        </div>
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">24565</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Chronicles of Narnia</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">60566167</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">June 18, 1950</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98294</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">16827462</span>
        </div>
        <div class="detail">
