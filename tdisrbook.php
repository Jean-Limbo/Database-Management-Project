...
<html lang="en">
    ...
    <link rel="stylesheet" type="text/css" href="tdisrbook.css">
...
<div class="cart-container">
    <div class="product-image">
        <img src="images/tdir.jpg" height="500px" alt="Book Cover">
    </div>
    ...
    <div class="informationprod">
        <div class="product-title">The Dark is Rising


        </div>
        <div class="author">Author: Susan Cooper
...
<div class="bookitemsdetails">
    ...
    <div class="book-card">
        <div class="detail">
            ...
            <span class="value">21776</span>
        </div>
        <div class="detail">
            <span class="label">Title:</span>
            <span class="value">The Dark is Rising</span>
        </div>
        <div class="detail">
            <span class="label">ISBN:</span>
            <span class="value">60928034</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">April 12, 1973</span>
        </div>
        <div class="detail">
            <span class="label">Publisher ID:</span>
            <span class="value">98314</span>
        </div>
        <div class="detail">
            <span class="label">Author ID:</span>
            <span class="value">8812783</span>
        </div>
        <div class="detail">
        ...
        <div class="detail">
            ...
            <span class="value">Susan Cooper</span>
        </div>
    </div>
</div>
